#!/bin/bash
# Fix payments.py: use @inject decorator with FromDishka.
...
@inject  # Required for Dishka to handle FromDishka dependencies
...
echo "payments.py updated with @inject decorator. Rebuilding app container..."
